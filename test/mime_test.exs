defmodule MimeMailTest do
  ...
  test "decode qp basic" do
    ...
    assert "Thequickbrownfoxjumpedoverthelazydog." =
             MimeMail.qp_to_binary("Thequickbrownfoxjumpedoverthelazydog.")
  end
  ...
  test "decode qp with spaces" do
    assert "The quick brown fox jumped over the lazy dog." =
             MimeMail.qp_to_binary("The quick brown fox jumped over the lazy dog.")
  end
  ...
  test "decode qp with non-strippable trailing whitespace" do
    assert "The quick brown fox jumped over the lazy dog.        " =
             MimeMail.qp_to_binary("The quick brown fox jumped over the lazy dog.       =20")

    assert "The quick brown fox jumped over the lazy dog.       \t" =
             MimeMail.qp_to_binary("The quick brown fox jumped over the lazy dog.       =09")

    assert "The quick brown fox jumped over the lazy dog.\t \t \t \t " =
             MimeMail.qp_to_binary("The quick brown fox jumped over the lazy dog.\t \t \t =09=20")

    assert "The quick brown fox jumped over the lazy dog.\t \t \t \t " =
             MimeMail.qp_to_binary(
  ...
  test "decode qp multiline stuff" do
    assert "Now's the time for all folk to come to the aid of their country." =
             MimeMail.qp_to_binary(
  ...
  test "roundtrip body encoding decoding" do
    decoded =
      File.read!("test/mails/encoded.eml")
